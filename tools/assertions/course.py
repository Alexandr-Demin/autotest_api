from client.courses.courses_schema import CourseResponseSchema, CourseSchema, CreateBodyRequestSchema, GetCoursesResponseSchema, UpdateBodyRequestSchema, UpdateCourseResponseSchema
...
def assert_course(actual: CourseSchema, expected: CourseSchema):
    ...
    assert_create_file(actual.preview_file, expected.preview_file)
...
def assert_get_courses_response(
    ...
    """
    assert_lenght(get_courses_response.courses, create_course_responses, "courses")
