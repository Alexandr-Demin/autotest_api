...
from client.exercises.exercises_client import ExercisesClient
from client.exercises.exercises_schema import CreateExerciseRequestSchema, CreateExerciseResponseSchema, GetExerciseResponseSchema, GetExercisesQuerySchema, GetExercisesResponseSchema, UpdateExerciseRequestSchema, UpdateExerciseResponseSchema
...
class TestExercises:
    ...
    def test_create_exercise(self, function_course: CorseFixture, exercises_client: ExercisesClient):
    ...
    def test_get_exercises(self, exercises_client: ExercisesClient, function_exercise: ExerciseFixture, function_course: CorseFixture,):
